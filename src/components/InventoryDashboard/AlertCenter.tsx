...
import { AlertTriangle, XCircle, Info, Snowflake, X, Bell, Check, Trash2, Zap, ShieldAlert } from 'lucide-react';
...
const typeConfig = {
  ...
  expiry_urgent: { icon: Zap, color: 'amber', label: '紧急预警' },
  expiry_expired: { icon: ShieldAlert, color: 'red', label: '过期预警' },
