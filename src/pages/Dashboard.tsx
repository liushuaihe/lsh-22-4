...
export default function Dashboard() {
  ...
  const warningBatches = batches.filter(b => b.status === 'approaching' && !b.isFrozen).length;
  const urgentBatches = batches.filter(b => b.status === 'urgent' && !b.isFrozen).length;
  ...
  const stats = [
    ...
    { label: '紧急批次', value: urgentBatches, icon: AlertTriangle, color: 'amber' },
