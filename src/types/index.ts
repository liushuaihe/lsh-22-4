...
export type ExpiryTier = 'normal' | 'approaching' | 'urgent' | 'expired';
...
export type AlertType = 'stock_shortage' | 'batch_occupied' | 'expiry_warning' | 'expiry_urgent' | 'expiry_expired' | 'over_sell' | 'frozen_batch';
export type AlertLevel = 'info' | 'warning' | 'error' | 'urgent';
